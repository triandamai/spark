# Spark: Small, lightweight, but starts something big.
...
A mostly-empty template to get started creating a Kotlin/JS project. 
...
The [kmp-js-wizard template](https://github.com/Kotlin/kmp-js-wizard/) is licensed under [CC0](https://creativecommons.org/publicdomain/zero/1.0/deed.en).
