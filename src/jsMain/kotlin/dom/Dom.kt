...
class ElementBuilder(val parent: VElement?) {
     ...
     * ```
     */
    fun div(block: dom.builders.DivBuilder.() -> Unit) {
        val el = VElement("div")
        val builder = dom.builders.DivBuilder(el, this)
        builder.block()
        builder.finalize()
    }
     ...
     * ```
     */
    fun button(block: dom.builders.ButtonBuilder.() -> Unit) {
        val el = VElement("button")
        val builder = dom.builders.ButtonBuilder(el, this)
        builder.block()
        builder.finalize()
    }
     ...
     * ```
     */
    fun p(block: dom.builders.ParagraphBuilder.() -> Unit) {
        val el = VElement("p")
        val builder = dom.builders.ParagraphBuilder(el, this)
        builder.block()
        builder.finalize()
    }
     ...
     * ```
     */
    fun input(block: dom.builders.InputBuilder.() -> Unit) {
        val el = VElement("input")
        val builder = dom.builders.InputBuilder(el, this)
        builder.block()
        builder.finalize()
    }
     ...
     * ```
     */
    fun a(href: String, block: dom.builders.AnchorBuilder.() -> Unit) {
        val el = VElement("a")
        el.attributes["href"] = href
        val builder = dom.builders.AnchorBuilder(el, this)
        builder.block()
        builder.finalize()
    }
     ...
     * ```
     */
    fun form(block: dom.builders.FormBuilder.() -> Unit) {
        val el = VElement("form")
        val builder = dom.builders.FormBuilder(el, this)
        builder.block()
        builder.finalize()
    }
     ...
     * ```
     */
    fun textarea(block: dom.builders.TextAreaBuilder.() -> Unit) {
        val el = VElement("textarea")
        val builder = dom.builders.TextAreaBuilder(el, this)
        builder.block()
        builder.finalize()
    }
     ...
     * ```
     */
    fun select(block: dom.builders.SelectBuilder.() -> Unit) {
        val el = VElement("select")
        val builder = dom.builders.SelectBuilder(el, this)
        builder.block()
        builder.finalize()
    }
     ...
     * ```
     */
    fun label(block: dom.builders.LabelBuilder.() -> Unit) {
        val el = VElement("label")
        val builder = dom.builders.LabelBuilder(el, this)
        builder.block()
        builder.finalize()
    }
     ...
     * ```
     */
    fun span(block: dom.builders.SpanBuilder.() -> Unit) {
        val el = VElement("span")
        val builder = dom.builders.SpanBuilder(el, this)
        builder.block()
        builder.finalize()
    }
     ...
     * ```
     */
    fun h1(block: dom.builders.H1Builder.() -> Unit) {
        val el = VElement("h1")
        val builder = dom.builders.H1Builder(el, this)
        builder.block()
        builder.finalize()
    }
     ...
     * ```
     */
    fun h2(block: dom.builders.H2Builder.() -> Unit) {
        val el = VElement("h2")
        val builder = dom.builders.H2Builder(el, this)
        builder.block()
        builder.finalize()
    }
     ...
     * ```
     */
    fun h3(block: dom.builders.H3Builder.() -> Unit) {
        val el = VElement("h3")
        val builder = dom.builders.H3Builder(el, this)
        builder.block()
        builder.finalize()
    }
     ...
     * ```
     */
    fun h4(block: dom.builders.H4Builder.() -> Unit) {
        val el = VElement("h4")
        val builder = dom.builders.H4Builder(el, this)
        builder.block()
        builder.finalize()
    }
     ...
     * ```
     */
    fun h5(block: dom.builders.H5Builder.() -> Unit) {
        val el = VElement("h5")
        val builder = dom.builders.H5Builder(el, this)
        builder.block()
        builder.finalize()
    }
     ...
     * ```
     */
    fun h6(block: dom.builders.H6Builder.() -> Unit) {
        val el = VElement("h6")
        val builder = dom.builders.H6Builder(el, this)
        builder.block()
        builder.finalize()
    }
     ...
     * ```
     */
    fun ul(block: dom.builders.UlBuilder.() -> Unit) {
        val el = VElement("ul")
        val builder = dom.builders.UlBuilder(el, this)
        builder.block()
        builder.finalize()
    }
     ...
     * ```
     */
    fun ol(block: dom.builders.OlBuilder.() -> Unit) {
        val el = VElement("ol")
        val builder = dom.builders.OlBuilder(el, this)
        builder.block()
        builder.finalize()
    }
     ...
     * ```
     */
    fun img(block: dom.builders.ImgBuilder.() -> Unit) {
        val el = VElement("img")
        val builder = dom.builders.ImgBuilder(el, this)
        builder.block()
        builder.finalize()
    }
     ...
     * ```
     */
    fun <ITEM> reactivity.State<List<ITEM>>.each(block: dom.builders.BaseElementBuilder.EachScope<ITEM, ElementBuilder>.(ITEM) -> Unit) {
        this.value.forEachIndexed { index, item ->
            val scope = dom.builders.BaseElementBuilder.EachScope<ITEM, ElementBuilder>(index, this@ElementBuilder)
            scope.block(item)
        }
    }
     ...
     * ```
     */
    fun <ITEM> reactivity.State<List<ITEM>>.eachIndexed(block: dom.builders.BaseElementBuilder.EachScope<ITEM, ElementBuilder>.(Int, ITEM) -> Unit) {
        this.value.forEachIndexed { index, item ->
            val scope = dom.builders.BaseElementBuilder.EachScope<ITEM, ElementBuilder>(index, this@ElementBuilder)
     ...
     * ```
     */
    fun <ITEM> reactivity.State<MutableList<ITEM>>.each(block: dom.builders.BaseElementBuilder.EachScope<ITEM, ElementBuilder>.(ITEM) -> Unit) {
        this.value.forEachIndexed { index, item ->
            val scope = dom.builders.BaseElementBuilder.EachScope<ITEM, ElementBuilder>(index, this@ElementBuilder)
            scope.block(item)
        }
     ...
     * ```
     */
    fun <ITEM> reactivity.State<MutableList<ITEM>>.eachIndexed(block: dom.builders.BaseElementBuilder.EachScope<ITEM, ElementBuilder>.(Int, ITEM) -> Unit) {
        this.value.forEachIndexed { index, item ->
